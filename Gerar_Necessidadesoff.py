...
if st.session_state["authentication_status"]:
    ...
    def abrir_confirmacao(chaves_recebidos, itens_recebidos):
        ...
        with col1:
            ...
            try:
                ...
                logger_info.info("O usuário marcou um item já recebido") # Log da tentativa de marcar item já recebido
    ...
    with col_button:
        if st.button('recarregar dados'):
            ...
            chaves_para_limpar = ['extract', 'pedidos', 'necessidades', 'df', 'desc_map', 'un_map', 'estoque_min_map', 'estoque_map', 'idped_map']
